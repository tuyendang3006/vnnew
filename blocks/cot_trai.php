            ...
            <div class="col1">
            	<div class="news">
                  <img class="images_news" src="upload/tintuc/<?php echo $row_tinxemnhieunhat['urlHinh'] ?>"  />
                    <h3 class="title" ><a href="index.php?=chitiettin&idTin=<?php echo $row_tinxemnhieunhat['idTin'] ?>"><?php echo $row_tinxemnhieunhat['TieuDe'] ?></a><span class="hit"><?php echo $row_tinxemnhieunhat['SoLanXem'] ?></span></h3>
                    <div class="clear"></div>
				</div>
            </div>
