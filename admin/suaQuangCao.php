...
<?php 
	$idQC = $_GET["idQC"]; settype($idQC, "int"); // render type "int"
    ...
    <table width="855" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <form id="form1" name="form1" method="post" action="">
            ...
            <tr>
              <td colspan="2" align="center">SỬA QUẢNG CÁO</td>
            </tr>
			<tr>
                <td>vitri</td>
                <td><label for="vitri"></label>
                <input value="<?php echo $row_quangcao["vitri"] ?>" type="text" name="vitri" id="vitri" size="50px" /></td>
			</tr>
			<tr>
                <td>MoTa</td>
                <td><label for="MoTa"></label>
                <input value="<?php echo $row_quangcao["MoTa"] ?>" type="text" name="MoTa" id="MoTa" size="50px"/></td>
            </tr>
			<tr>
                <td>Url</td>
                <td><label for="Url"></label>
                <input value="<?php echo $row_quangcao["Url"] ?>" type="text" name="Url" id="Url" size="50px"/></td>
            </tr>
            <tr>
                <td>urlHinh</td>
                <td><label for="urlHinh"></label>
                <input value="<?php echo $row_quangcao["urlHinh"] ?>" type="text" name="urlHinh" id="urlHinh" />
